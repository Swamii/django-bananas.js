...
function (_React$Component2) {
  ...
  function Page(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Page).call(this, props)); // Destruct named props to filter out props to pass over to page component

    var classes = props.classes,
        component = props.component,
        controller = props.controller,
        pageProps = _objectWithoutProperties(props, ["classes", "component", "controller"]);
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          PageComponent = _this$state.PageComponent,
...
function (_React$Component3) {
  ...
  function PageLoadController(props) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(PageLoadController).call(this, props));
    _this2.meter = new _utils.MultiMeter();
    return _this2;
  }
